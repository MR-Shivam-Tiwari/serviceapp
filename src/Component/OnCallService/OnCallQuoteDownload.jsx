...
const OnCallQuoteDownload = () => {
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      for (let i = 0; i < pages.length; i++) {
        ...
        const yPosition =
          pdfHeight < pageHeight ? (pageHeight - pdfHeight) / 2 : 0;
  ...
  transform: scale(0.4); /* Scale down for mobile viewing */
  transform-origin: top left; /* Keep top-left aligned */
}
          ...
          <div className="pdf-page">
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1">
                  <div className="text-xs leading-relaxed space-y-1 font-bold selectable-text">
                    <p>
                      Ref #: {quoteData?.onCallNumber} Rev-
                      {quoteData?.currentRevision}
                    </p>
                    <p>Date - {formatDate(quoteData?.createdAt)}</p>
                    <p>
                      Complaint ID:{" "}
                      {quoteData?.complaint?.notification_complaintid}
                    </p>
                    <p>Serial Number: {quoteData?.complaint?.serialnumber}</p>
                  </div>
                </div>
            ...
            <div className="page-content">
              ...
              <div className="space-y-4 text-sm leading-relaxed selectable-text">
                ...
                <p>
                  We look forward to your valued order and long term
                  relationship.
                </p>
                ...
                <div className="mt-8 space-y-2">
                  ...
                  <div className="mt-4">
                    <p className="font-semibold">{quoteData?.createdBy}</p>
                    <p className="text-black">Representative</p>
                    <div className="text-sm mt-1 text-black">
                      *This is an electronically generated quotation, no
                      signature required.
                    </div>
                  </div>
                </div>
            ...
            <div className="page-footer">
              <div className="text-center text-[11px] text-black leading-tight space-y-1 selectable-text">
                ...
                <p>
                  Healthcare Division: #360, KIADB Industrial Area, Hebbal,
                  Mysuru - 570018, INDIA. P +91 8212407000 E office@skanray.com
                  W www.skanray.com
                </p>
              </div>
            </div>
            ...
            <div className="page-header">
              <div className="flex justify-between items-start">
                <div className="text-xs leading-relaxed space-y-1 font-bold text-black selectable-text">
                  ...
                  <p>
                    Form No{" "}
                    {quoteData?.complaint?.notification_complaintid || "N/A"}
                  </p>
                  <p>
                    Opportunity Number :{" "}
                    {quoteData?.complaint?.notification_complaintid || "N/A"}
              ...
              <div className="text-xs leading-relaxed space-y-0 selectable-text">
                ...
                <div className="space-y-0">
                  <p>
                    ...
                    Notification TCS (Tax collection at Source) will be charged
                    if applicable at the rate of 0.1% if PAN / Aadhaar is
                  ...
                  <p>
                    3. All the orders should be placed on M/s Skanray
                    Technologies Limited., Mysore for supply of goods
                  </p>
                  <p>
                ...
                {quoteData?.productGroups.map((group, groupIndex) => (
                  <div key={group.productPartNo}>
                    ...
                    <div>
                      ...
                      <p className="text-sm">
                        Main Unit 1 Year, Accessories 6 months,
                        Disposable/Consumable No Warranty
                      </p>
                    </div>
                  </div>
                ))}
              ...
              <div className="space-y-6 text-sm leading-relaxed selectable-text">
                ...
                <div>
                  ...
                  <p>
                    ...
                    thirty days from the date of quotation and thereafter,
                    subject to our confirmation. Offer would be considered as
                    accepted on receipt, by the supplier, of technically and
                    commercially clear order along with the despatch
                ...
                <div>
                  ...
                  <p>
                    ...
                    supplier's acknowledgement of purchaser's order. The
                    purchaser shall be deemed to have understood and agreed to
                    accept the conditions contained herein and the specific
                ...
                <div>
                  ...
                  <p>
                    ...
                    Please provide the full address of your bankers in your
                    order.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6 text-sm leading-relaxed selectable-text">
                <div>
                  ...
                  <p>
                    ...
                    receipt of technically and commercially clear order along
                    with the despatch instructions / agreed advance amount etc.,
                    whichever is later.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    ...
                    enable the supplier to install the equipment. Purchaser
                    shall also comply with requirements of Atomic Energy
                    Regulatory Board (AERB) Guidelines for setting up of new
                ...
                <div>
                  ...
                  <p>
                    ...
                    recommended by the supplier so as to ensure that the
                    equipment does not suffer damage due to humidity, dust,
                    pests, severe temperature etc. The purchaser shall ensure
                    that the equipment is operated, as per the operating
              ...
              <div className="mb-8 selectable-text">
                ...
                <div className="text-sm leading-relaxed space-y-3">
                  <p>
                    ...
                    Purchaser shall obtain license to operate within 3 months
                    from completion of installation & On-site QA tests.
                  </p>
                  <p>
                    After completion of installation & On-site QA tests, end
                    user shall obtain license to use the equipment from AERB
                    before using on actual patients.
                  </p>
              ...
              <div className="mb-8 selectable-text">
                ...
                <div className="text-sm leading-relaxed space-y-3">
                  <p>
                    ...
                    arising from material or workmanship for a period of
                    12months from the date of installation or 15 months from the
                    date of shipment, whichever is earlier.
                  </p>

                  <p className="font-semibold">
                    a)Price of the X-Ray Tube or FFD or HF X-Ray Generators =
                    Rs. X
                  </p>
                  <p className="font-semibold">
          ...
          <div className="pdf-page">
            ...
            <div className="page-content">
              ...
              <div className="mb-8 selectable-text">
                ...
                <div className="text-sm leading-relaxed space-y-4">
                  <p>
                    ...
                    Purchase Order Value + service taxes or Service on Call
                    Basis.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-8 selectable-text">
                ...
                <div className="text-sm leading-relaxed space-y-4">
                  <p>
                    Except as otherwise provided explicitly hereinabove, we
                    shall not be liable for any special or consequential damages
                    of any kind or nature, arising out of use of this equipment.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-8 selectable-text">
                ...
                <div className="text-sm leading-relaxed space-y-4">
                  <p>
                    We shall not be responsible for any failure in performing
                    our obligations, if such non performance is due to reasons
                    beyond our control.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-8 selectable-text">
                ...
                <div className="text-sm leading-relaxed space-y-4">
                  <p>
                    The foregoing terms & conditions shall prevail
                    notwithstanding any variations contained in any document
                    received from the customer, unless such variations have been
                    specifically agreed upon in writing by Skanray Technologies
                    Limited.
                  </p>
                </div>
              </div>
...
export default OnCallQuoteDownload;
