...
const CmcNcmcQuoteTemplate = () => {
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      const fileName = `${quoteData?.proposalNumber || "Proposal"}-Rev${
  ...
  transform-origin: top left; /* Keep top-left aligned */
      ...
      <div className="max-w-4xl pdf-container mx-auto text-black py-4">
...
export default CmcNcmcQuoteTemplate;
