...
export default function ProposalDetails() {
  ...
  return (
    ...
    >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div className="text-center">
                            ...
                            <p className="font-bold text-lg text-green-600">
                              ₹
                              {itemCalc?.pricePerYear?.toLocaleString(
                                "en-IN"
                              ) || "0"}
                            </p>
                          </div>
                          <div className="text-center">
                            ...
                            <p className="font-bold text-lg text-green-600">
                              ₹
                              {itemCalc?.subtotal?.toLocaleString("en-IN") ||
                                "0"}
                            </p>
                          </div>
                        </div>
      ...
      {/* Fixed Submit Button - Above navigation bar */}
      {!keyboardVisible && (
        <div
          className="fixed bottom-0 left-0 right-0 bg-gray-50 border-t shadow-lg z-30"
          style={{
            paddingBottom: `${safeAreaInsets.bottom + 8}px`, // Add extra padding above navigation
          }}
        >
          <div className="p-3">
            <button
